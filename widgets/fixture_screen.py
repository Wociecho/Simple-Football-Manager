...
class FixtureScreen(tk.Frame):
    ...
    def check_gameweek(self):
        league = self.master.current_selected_league
    ...
    def display_fixture(self):
        ...
        for match in fixture:
            ...
            self.home_label.grid(row=grid_index, column=0, sticky='nswe', pady=(5, 5))
            ...
            self.score_label.grid(row=grid_index, column=1, sticky='nswe', pady=(5, 5))
            ...
            self.away_label.grid(row=grid_index, column=2, sticky='nswe', pady=(5, 5))
            grid_index += 1
    ...
    def get_no_of_games(self):
        ...
        cursor.execute("""
            SELECT MAX(kolejka) FROM mecze WHERE poziom_rozgrywkowy = ? AND rozgrywki = 'league'
    ...
    def get_matches(self):
        ...
        cursor.execute("""
            ...
            FROM mecze
            WHERE kolejka = ? and poziom_rozgrywkowy = ? and rozgrywki = 'league'
        """, (self.gameweek_to_show, self.master.current_selected_league,))
